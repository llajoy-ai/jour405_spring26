...
The correlation calculation shows that there is a high chance that GDP and DJIA have a strong connection. A score of 0.9 is very high and almost to 1.0. Based on the scatterplot, it seems that when the GDP increases, so does the DJIA. The data goes from 2013 to 2024 so there is over 10 years of data being compiled. Therefore, I think this is enough data to actually be able to tell that there is an upward trend when both GDP and DJIA increase. There are some outliers on the line, however there is still mostly an upward curve occurring. 
