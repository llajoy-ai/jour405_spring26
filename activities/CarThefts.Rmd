...
No the distribution is not normal. It is skewed to the left because there is more data on the left side of the graph than on the right. One standard deviation to the right does not have much of a range of numbers meaning they are very close together, however on the left there is a large range in values. I would say that most of the data falls in the range of the standard deviations and the least amount of data is outside of one standard deviation from the mean. 
