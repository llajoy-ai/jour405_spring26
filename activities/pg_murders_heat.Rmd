...
```{r}
murder_temp|> summarise(correlation =cor(murders, temperature, method = "pearson"))
```
...
The results of the correlation calculation show that there is a significant amount of data that correlates the amount of murder with temperatures. The plot suggests that it might not be just temperature because in some hotter months the data is lower which suggests that summer does not play a role. 
