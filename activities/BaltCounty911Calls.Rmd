...
If I had to draw horizontal lines to indicate what the unusal days are I would put lines on the far top and far bottom. I think these are the main outliers because the other data sets were all around the middle howevere the ones in the top or bottom are outliers because they are extremes on both sides, very low and very high. I think it would be interesting to specifically look at the highest in October and the lowest in July and January. 
...
You are comparing the highest amount of the drug that is used and shows how many standard deviations from the mean the score is. Meaning it shows how much higher or lower the result is from the average based on the standard deviation. In the most basic of terms it explains how far of an outlier a piece of data is from the average. 
...
Some potential angles for this story would be to look into what was happening on the days and year specifically where there were the highest anounts of use. I think it would be interesting to try and find an actual connection instead of just saying that there was an issue at that time. Looking into the specific day and trying to figure out what the potential cordinations could be could potentially alert the public in case a similar event is happening so that people can be on the look out. I also think it would be interesting to do a story on the days of the week that are worse. I think it would be interesting to look into why some days of the week are seemingly less likely for the drug to be used and see how often there are impacts based on certain days of the week instead of just specific days. 
